...
mod test {
    ...
    #[test]
    fn test_arithmetic() {
        assert_eq!(eval("(+ 55 42)"), Literal::Integer(97));
        assert_eq!(eval("(* 21 2)"), Literal::Integer(42));
        assert_eq!(eval("(+ 1 (* 2 3))"), Literal::Integer(7));
        assert_eq!(eval("(+ (* 2 3) (* 3 4))"), Literal::Integer(18));
    }
